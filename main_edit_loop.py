...
# To do
# -probalistic precipitation
# -Toevoegen snapshot_number bij alle dingen, zoals bij Ika
...
class CatchmentModel(pcrfw.DynamicModel): #pcrfw.MonteCarloModel):
  ...
  def premcloop(self):
    ...
    # variable_name  = generalfunctions.file_name_str("demM", step)    
...
#TIJMEN
  ...
  def createInstancesInitial(self):
    ...
    if cfg.readDistributionOfParametersFromDisk:
      ...
      variable_name  = generalfunctions.file_name_str("micM", step)
      ...
      variable_name  = generalfunctions.file_name_str("Iks", snapshot_number, step)
      ...
      variable_name  = generalfunctions.file_name_str("regM", step)
...
#TIJMEN 
    ...
    variable_name  = generalfunctions.file_name_str("laiM", step)    
    ...
    variable_name  = generalfunctions.file_name_str("moiM", step)    
...
#TIJMEN
    ...
    variable_name  = generalfunctions.file_name_str("bioM", step)    
...
# and step --> 0.100
# dus de nodige loop wordt het onderstaande:

#for step in np.arange(100, cfg.numberOfTimeSteps + cfg.interval_map_snapshots, cfg.interval_map_snapshots):
