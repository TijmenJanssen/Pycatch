...
#TIJMEN: één snapshot te nemen, nummer van snapshot kan je wijzigen door getal achter enumerate te wijzigen, 
# ergens tussen 100 en 5000. Origineel: for k, step in enumerate([100]):
#for k, step in enumerate([100]):
# snapshot_number = str(k).zfill(2)
    
    
# TIJMEN: om over snapshots te loopen, origineel: for k, step in enumerate(np.arange(100, cfg.numberOfTimeStepsFromWeekly + 100, 100)):
for k, step in enumerate(np.arange(100, cfg.numberOfTimeStepsFromWeekly + 100, 200)):
     snapshot_number = str(k).zfill(2)
